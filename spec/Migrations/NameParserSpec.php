...
class NameParserSpec extends ObjectBehavior
{
    ...
    public function it_parses_a_migration_name_into_an_array()
    {
    ...
    public function it_parses_a_migration_name_where_the_table_is_two_words()
    {
    ...
    public function it_parses_a_complex_migration_name()
    {
