...
class SchemaParserSpec extends ObjectBehavior
{
    ...
    public function it_parses_a_basic_string_schema()
    {
    ...
    public function it_parses_schema_with_multiple_fields()
    {
    ...
    public function it_parses_schema_that_includes_extras()
    {
    ...
    public function it_parses_correctly_when_the_type_contains_method_arguments()
    {
    ...
    public function it_parses_schema_with_multiple_fields_using_no_spaces()
    {
    ...
    public function it_parses_schema_fields_that_want_foreign_constraints()
    {
